                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-13"><a href="{{ url('my-account') }}">My-account</a>
                                    > Order Details</h4>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div class="mb-3">
                                            ...
                                            <h5>Outlet Name : {{ $order_details->outlet_name }}</h5>
                                            ...
                                            <h6>GST No : {{$customer->gst }}</h6>
                                            <h6>Billing Address:{{ $customer->billing_address }}</h6>
                                            <h6>Delivery Address:{{ $customer->delivery_address }}</h6>
                                            @php
                                            $Date = $customer->created_at;
                                            $deliverydate = date ('d-m-Y', strtotime($Date. ' + 2 days'));
                                            @endphp
                                            <h6>Delivery Date:{{ $deliverydate}}</h6>
