@include('admin.header')
    ...
    <body>
        ...
        <div id="layout-wrapper">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->email }}</td>
                                                <td>
                                                    <a href="{{url('admin/correctiondetails/'.$item->email)}}">
            ...
            //           //console.log(roles);
            //           let url = "{{ url('admin/filter-correction') }}" + "/" + "status=" + status;
            ...
            //                 <td>${roles.city}</td> 
            //                 <td>
            //                     <a href="{{url('admin/correctiondetails/')}}/${roles.email}">
            //                     <button type="button" class="btn btn-primary waves-effect waves-light"> <i class="fas fa-eye"></i></button>
            //                     </a>
            //                 </td> 
            //                 <td>${newstatus}</td>  
...
$('#status').change(function() {
    ...
    jQuery.ajax({
        url: '{{ url('admin/filter-correction') }}',
        type: 'POST',
        headers: {
