                ...
                <div class="container-fluid">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    ...
                                                    <a href="{{ url('admin/add-customers') }}"><button type="button"
                                                            class="btn btn-primary waves-effect waves-light ml-3">Add</button></a>
                                                </div>
                                            </div>
                                        </div>
                                        <form action="{{ url('admin/importcustomers') }}" method="POST"
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    <input type="file" name="file" class="form-control"
                                                        style="width: 100%" required accept=".xls, .xlsx">
                                                    <br>
                                                    <button class="btn btn-success ml-3">
                                                        Import
                                                    </button>
                                                    <a class="btn btn-warning ml-3"
                                                        href="{{ url('admin/exportcustomers') }}">
                                                        Export
                                                    </a>
                                                </div>
                                            </div>
                                        </form>
                                        <form action="{{ url('admin/outletsimport') }}" method="POST"
                                            enctype="multipart/form-data" class="d-flex mt-4 justify-content-end">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <a class="btn btn-warning ml-3"
                                                        href="{{ url('admin/outletsexport') }}">
                                                        Export
                                                    </a>
                                                </div>
                                            </div>
                                        </form>
                                        <form action="{{ url('admin/discountimport') }}" method="POST"
                                            enctype="multipart/form-data" class="d-flex mt-4 justify-content-end">
                                                    ...
                                                    @isset($customers)
                                                        @foreach ($customers as $key => $item)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a
                                                                        href="{{ url('admin/customerdetails/' . $item->email) }}">
                                                                        <button type="button"
                                                                ...
                                                                <td>
                                                                    <a
                                                                        href="{{ url('admin/discount-customers/' . $item->email) }}"><button
                                                                            class="btn btn-success"
                                                                            style="color :white">discount</button></a>
                                                                    <a
                                                                        href="{{ url('admin/edit-customers/' . $item->email) }}"><button
                                                                            class="btn btn-primary"
                                                                            style="color :white">Edit</button></a>
                                                                    <a
                                                                        href="{{ url('admin/delete-customers/' . $item->email) }}"><button
                    ...
                    @elseif ($layout == 1)
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{ url('admin/customers') }}">Customers</a>
                                        > Add Customer</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('admin/add-customers') }}" method="POST"
                                            ...
                                            <div class="row mt-md-4 mt-3">
                                                <div class="col-12">
                                                    ...
                                                    <div class="btns d-inline-block">
                                                        <a href="{{ url('admin/customers') }}"><button type="button"
                    ...
                    @elseif($layout == 2)
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"> <a
                                            href="{{ url('admin/customers') }}">Customers</a> > Edit Customers</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('admin/edit-customers/' . $customer['email']) }}"
                                            ...
                                            <div class="row mt-4" id="req_input">
                                                ...
                                                <div class="row px-3 required_inp">
                                                    ...
                                                    @for ($i = 0; $i < count($outlet_name); $i++)
                                                        ...
                                                        <div class="col-md-4 form-group">
                                                            <label for="simpleinput">Phone Number <span
                                                                    style="color: red">*</span></label>
                    ...
                    @elseif($layout == 3)
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a
                                            href="{{ url('admin/customers') }}">Customers</a> > Discount Customer</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('admin/discount-customers/' . $customer['email']) }}"
                                            method="POST" enctype="multipart/form-data">
                                            @csrf
                    ...
                    @elseif($layout == 4)
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a
                                            href="{{ url('admin/customers') }}">Customers</a> > All Details</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                                        ...
                                                        <div class="details">
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @isset($customers->photo)
                                                                            <a href="{{ url('image/' . $customers->photo) }}"
                                                                                target="_blank">
                                                                                <img src="{{ url('image/' . $customers->photo) }}"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p>{{ date('d-m-Y', strtotime($customers->created_at)) }}
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p>{{ $customers->credit_period }} Days</p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <p>Rs {{ $customers->credit_amount }} ₹</p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="details">
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <p>Outlet SPOC Number</p>
                                                                        </td>
                                                                        <td>
                                                                            <p>{{ $outlet_spoc_number[$i] }}</p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <p>FDA icense Number:</p>
                                                                        </td>
                                                                        <td>
                                                                            <p>{{ $fda_license_number[$i] }}</p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <p>FDA License Expiry date:</p>
                                                                        </td>
                                                                        <td>
                                                                            <p>{{ date('d-m-Y', strtotime($expirydate[$i])) }}

                                                                @foreach ($expirydate as $expiry)
                                                                    @php
                                                                        $expiryDateObj = new DateTime($expiry);
                                                                        ...
                                                                        <td>
                                                                            @isset($document[$i])
                                                                                @if (pathinfo($document[$i], PATHINFO_EXTENSION) == 'jpeg')
                                                                                    <a href="{{ url('image/' . $document[$i]) }}"
                                                                                        target="_blank">
                                                                                        <img src="{{ url('image/' . $document[$i]) }}"
                                                                                            height="50px"
                                                                                            width="50px"></a>
