                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-13"><a href="{{ url('admin/correction') }}">Correction</a> >
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                                    ...
                                                    <div class="col-12">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p>{{ date('d-m-Y', strtotime($customers->created_at)) }}</p>
                                                                </td>
                                                            </tr>
                                    ...
                                    <!-- end card-body-->
                                    <form action="{{ url('admin/changestatus/' . $customers->email) }}" method="post">
                                        @csrf
                                        @if ($customers->status != 'Approved')
                                            ...
                                            <div class="row px-3 mt-4">
                                                <div class="col-12">
                                                    ...
                                                    <div class="btns d-inline-block">
                                                        <a href="{{ url('admin/correction') }}"><button type="button"
