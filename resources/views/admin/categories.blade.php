                ...
                <div class="container-fluid">
                  ...
                  <div class="row">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    ...
                                                    <a href="{{ url('admin/add-category') }}"><button type="button" class="btn btn-primary waves-effect waves-light ml-3">Add</button></a>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    @isset($category)
                                                        @foreach ($category as $key => $item)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a
                                                                        href="{{ url('admin/edit-category/' . $item->id) }}"><button
                                                                            class="btn btn-primary">Edit</button></a>
                                                                    <a
                                                                        href="{{ url('admin/delete-category/' . $item->id) }}"><button
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-13"><a href="{{url('admin/category')}}">Categories</a> > Add Categories</h4>
                            </div>
                        </div>
                    </div> 
                                        ...
                                        <form action="{{ url('admin/add-category') }}" method="POST"
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationTooltip01"><b> Category</b></label>
                                                    <input type="text" class="form-control" id="validationTooltip01"
                                                        name="category_name" placeholder="Enter Category" required>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationTooltip01"><b>Sub Category</b></label>
                                                    <input type="text" class="form-control" id="validationTooltip01"
                                                        name="sub_category" placeholder="Enter Sub Category" required>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationTooltip01"><b>Sub Sub Category</b></label>
                                                    <input type="text" class="form-control" id="validationTooltip01"
                    ...
                    @elseif($layout == 2)
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{url('admin/category')}}">Categories</a> > Edit Categories</h4>
                                </div>
                            </div>
                        </div> 
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('admin/edit-category/' . $category['id']) }}"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationTooltip01"><b>Access</b></label>
                                                    <select name="access" id="" class="form-control" required>
                                                        <option value="">Select Access</option>
