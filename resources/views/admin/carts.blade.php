...
<body>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @else
                                        <p>Please Add Item from <a href="{{ url('admin/products') }}">Products</a></p>
                                    @endif
                                </div>
                                <!-- end card-body-->
                            </div>
    ...
    function changeMoq(productId) {
        ...
        var $input = $('.cart-plus-minus-box' + productId);
        var $plus = $('.plus' + productId);
        var $minus = $('.minus' + productId);
        var $subtotal = $('.cart-product-subtotal' + productId);
        var moq = parseFloat($('.moqs' + productId).val());
        ...
        function updateTotal() {
            ...
            $('.cart-product-sub').each(function() {
                var subtotalValue = parseFloat($(this).text());
