                    ...
                    <div class="row"> 
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-13"><a href="{{url('admin/vehicle')}}">Vehicles</a> > Add Vehicle</h4>
                            </div>
                        </div>
                    </div>    
                    <!-- end page title -->
                                    ...
                                    <form action="{{url('admin/addvehicle')}}" method="POST">
                                      ...
                                      <div class="row mt-md-4 mt-3">
                                        <div class="col-12">
                                           ...
                                           <div class="btns d-inline-block">
                                               <a href="{{url('admin/vehicle')}}"><button type="button" class="btn btn-dark waves-effect waves-light">Cancel</button></a>
                                           </div>
                                        </div>
                                     </div>
                                    </form>
