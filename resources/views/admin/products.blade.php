                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    ...
                                                    <a href="{{ url('admin/add-product') }}"><button type="button"
                                                            class="btn btn-primary waves-effect waves-light ml-3">Add</button></a>
                                                </div>
                                            </div>
                                        </div>
                                        <form action="{{url('admin/filter-products')}}" method="POST">
                                            @csrf
                                        <div class="d-flex justify-content-between mt-3 float-right">
                                            ...
                                            <div class="mx-3">
                                                <a href="{{url('admin/products')}}"  class="btn btn-primary waves-effect waves-light">                                                      Reset</a>
                                            </div>
                                        </div>
                                            </div>
                                        </div>
                                    ...
                                    <form action="{{ route('importsuperadmin') }}"
                                      ...
                                      <a class="btn btn-warning ml-3"
                                        ...
                                        {{-- <a class="btn btn-danger ml-3"
                                         href="{{ url('admin/truncateproduct') }}"  onclick="return confirm('Are you sure you want to Empty the All Data?');">
                                             Empty
                                        </a> --}}
                                    </form>
                                        </div>
                                                    ...
                                                    @isset($products)
                                                        @foreach ($products as $key => $item)
                                                            <tr rowspan='2'>
                                                                ...
                                                                <td><a
                                                                        href="{{ url('admin/product-details/' . $item->id) }}">
                                                                        <button type="button"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a
                                                                        href="{{ url('admin/edit-product/' . $item->id) }}"><button
                                                                            class="btn btn-primary"
                                                                            style="color:white">Edit</button></a>
                                                                    <a
                                                                        href="{{ url('admin/delete-product/' . $item->id) }}"><button
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{url('admin/products')}}">Products</a> >Add Products</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('/admin/add-product') }}" method="POST"
                                            ...
                                            <button class="btn btn-primary waves-effect waves-light" type="submit">
                                                ...
                                                <div class="btns d-inline-block">
                                                    <a href="{{url('admin/products')}}"><button type="button" class="btn btn-dark waves-effect waves-light">Cancel</button></a>
                                                </div>
                                                </div>
                                            </div>
                                        </form>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-13"><a href="{{url('admin/products')}}">Products</a> > Edit Products</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title -->
                                ...
                                <div class="form-row">
                                    ...
                                    {{-- <div class="col-md-3 mb-3">
                                        <label for="validationTooltip03"><b>Stcoks <span
                                                    style="color: red">*</span></b></label>
                                        <input type="number" class="form-control" value="{{ $product['stocks'] }}" required
                                            name="stocks" placeholder="Enter Stocks">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-13"><a href="{{url('admin/products')}}">Products</a> > Product Details</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
