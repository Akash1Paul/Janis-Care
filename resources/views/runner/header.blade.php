...
<header id="page-topbar">
    <div class="navbar-header">
        <a href="{{url('runner/order')}}"><img src="https://website-project.in/jeniscare/public/img/janiscare-logo.svg" width="15%" alt="" style="height:160px;width:20%" ></a>
            ...
            <div class="dropdown d-inline-block ml-2">
                <button type="button" class="btn header-item waves-effect waves-light"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{url('/assets/images/users/avatar-3.jpg')}}"
                        alt="Header Avatar">
                    <span class="d-none d-sm-inline-block ml-1">Runner</span>
