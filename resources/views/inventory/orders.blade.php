                                            ...
                                            <div class="fields d-flex">
                                                ...
                                                {{-- <div class="mx-3">                                       
                                                    <select class="form-control mb-3">
                                                        ...
                                                        <option>TM Approval</option>
                                                    </select>
                                                </div>     --}}
                                                <div class="mr-1">
                                                    <a href="{{ url('inventory/carts') }}"><button type="button" class="btn btn-primary waves-effect waves-light"> Add Order</button></a>
                                                </div>                                       
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered mb-0">
                                                ...
                                                <tbody id="filterorders">
                                                    ...
                                                    <tr >
                                                        <th>{{$index+1}}</th>
                                                        <th>{{ date('d-m-Y',strtotime($value->created)) }}</th>
                                                        <th>{{$value->outlet_name}}</th>
                                                        <th></th>
                                                        <th>{{ $value->city }}</th>
                                                       <th>{{ $value->address }}</th>
                                                       ...
                                                       $created_Date = date('d-m-Y', strtotime($value->created));
                                                    ...
                                                    //    dd($diff_days);
                                                       @endphp
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ url('inventory/orders-details/' . $value->id)}}">
                                                                <button type="button"
                                                        ...
                                                        <td>
                                                            <button type="button"
                                                                class="btn btn-success waves-effect waves-light">{{ $value->status }}</button>
                                                        </td>
                                                    </tr>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('inventory/add-orders/') }}" method="POST">
                                           @csrf
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="pincode" class="form-control"
                                                            placeholder="Enter code" id="pincode">
                                                    </div>
                                            ...
                                            <div class="row mt-md-4 mt-3">
                                                <div class="col-12">
                                                    ...
                                                    <div class="btns d-inline-block">
                                                        <a href="{{ url('inventory/orders') }}"><button
                                                                type="button"
                                                                class="btn btn-dark waves-effect waves-light">Cancel</button></a>
                                                    </div>
                                                </div>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('#status').change(function{
                ...
                jQuery.ajax({
                    url: '{{ url('inventory/filter-orders') }}',
                    type: 'POST',
                    headers: {
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('#phone').keyup(function() {
                ...
                jQuery.ajax({
                    url: '{{ url('inventory/fetch-user-details') }}',
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
