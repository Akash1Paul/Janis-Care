                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="mx-3">                                       
                                                <select class="form-control mb-3"id="roles">
                                                    ...
                                                    <option valuse="backoffice">Back Office</option>
                                            ...
                                            <a href="{{ url('hr/add-users') }}"><button type="button"
                                                ...
                                                <tbody  id="myTable">
                                                    @foreach ($users as $index => $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a
                                                                    href="{{ url('hr/edit-users/' . $item->email) }}">
                                                                    <button type="button"
                                                                        class="btn btn-primary waves-effect waves-light">Edit</button>
                                                                </a>
                                                                <a
                                                                    href="{{ url('hr/delete-users/' . $item->email) }}">
                                                                    <button type="button"
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{url('hr/roles')}}">Roles</a> > Add Role</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{url('hr/add-users') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mt-4">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select onchange="change(event)" name="roles"  class="form-control mb-3">
                                                ...
                                                <div class="col-md-4" id="name">
                                                    <div class="form-group">
                                                        <label for="name">Name <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" name="name" class="form-control" placeholder="Enter Name" id="nameinput">
                                                    @error('name')
                                                        <span style="color:red">{{ $message }}</span>
                                                    @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4" id="emplId">
                                                    <div class="form-group">
                                                        <label for="name">Employee Id <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" name="empid" class="form-control" placeholder="Enter Id" id="empidinput" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4" id="phone">
                                                    <div class="form-group">
                                                        <label for="name">Phone Number<span
                                                            style="color: red">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter Number" name="phone" id="phoneinput" >
                                                        @error('phone')
                                                        <span style="color:red">{{ $message }}</span>
                                                    @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4" id="workAdd">
                                                    <div class="form-group">
                                                        <label for="name">Work Address <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter Work Address" id="workaddressinput"  name="workaddress">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="homeAdd">
                                                    <div class="form-group">
                                                        <label for="name">Home Address <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter Home Address" name="homeaddress" id="homeaddressinput">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="addProof">
                                                    <div class="form-group">
                                                        <label for="name">Upload Address Proof Document <span
                                                            style="color: red">*</span></label>
                                                        <input type="file" name="addressproof" id="addressproofinput" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="ageProof">
                                                    <div class="form-group">
                                                        <label for="name">Upload Age Proof Document <span
                                                            style="color: red">*</span></label>
                                                        <input type="file"  name="document"  id="documentinput"class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4" id="wareSpocName">
                                                    <div class="form-group">
                                                        <label for="name">SPOC Name <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter SPOC Name" name="spoc_name">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="wareSpocNumber">
                                                    <div class="form-group">
                                                        <label for="name">SPOC Number <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter SPOC Number" name="spoc_number">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="vehicleChoose">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="multiSelect">
                                                            <select multiple class="multiSelect_field" data-placeholder="Add Vehicle" name="vehicle">
                                                ...
                                                <div class="col-md-4" id="wareRunner">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="multiSelect2">
                                                            <select multiple class="multiSelect_field2" data-placeholder="Add Runner" name="runner">
                                                ...
                                                <div class="col-md-4" id="email">
                                                    <div class="form-group">
                                                        <label for="name">Email <span
                                                            style="color: red">*</span></label>
                                                        <input type="email" class="form-control" placeholder="Enter Email" name="email" id="emailinput">
                                                        @error('email')
                                                        <span style="color:red">{{ $message }}</span>
                                                    @enderror
                                                    </div>
                                          ...
                                          <div class="row mt-md-4 mt-3">
                                            <div class="col-12">
                                               ...
                                               <div class="btns d-inline-block">
                                                   <a href="{{url('hr/roles')}}"><button type="button" class="btn btn-dark waves-effect waves-light">Cancel</button></a>
                                               </div>
                                            </div>
                                         </div>
                                        </form>
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-13"><a href="{{url('hr/roles')}}">Roles</a> > Edit Roles</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ url('hr/edit-users/' . $user->email) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mt-4">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="name">Role<span
                                                            style="color: red">*</span></label>
                                                        <select onchange="change(event)" name="roles"  class="form-control mb-3" id="yourSelect">
                                                            <option disabled selected>Select Role</option>
                                                            <option value="warehouse"  {{$user['roles'] == 'warehouse' ? 'selected' : ''}}>Warehouse</option>
                                                            <option value="territory" {{$user['roles'] == 'territory' ? 'selected' : ''}}>Territory Manager</option>
                                                            <option value="relationship" {{$user['roles'] == 'relationship' ? 'selected' : ''}}>Relationship Manager</option>
                                                            <option value="backoffice" {{$user['roles'] == 'backoffice' ? 'selected' : ''}}>Back Office</option>
                                                            <option value="admin" {{$user['roles'] == 'admin' ? 'selected' : ''}}>Admin</option>
                                                            <option value="runner" {{$user['roles'] == 'runner' ? 'selected' : ''}}>Runner</option>
                                                        </select>
                                                ...
                                                <div class="col-md-4" id="name">
                                                    <div class="form-group">
                                                        <label for="name">Name <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" name="name" class="form-control" placeholder="Enter Name" value="{{$user->name}}" id="nameinput">
                                                    @error('name')
                                                        <span style="color:red">{{ $message }}</span>
                                                    @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4" id="emplId">
                                                    <div class="form-group">
                                                        <label for="name">Employee Id <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" name="empid" class="form-control" placeholder="Enter Id"  id="empidinput"  value="{{$user->empid}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="ChooseWh">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4" id="phone">
                                                    <div class="form-group">
                                                        <label for="name">Phone Number<span
                                                            style="color: red">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter Number" name="phone" id="phoneinput" value="{{$user->phone}}">
                                                        @error('phone')
                                                        <span style="color:red">{{ $message }}</span>
                                                    @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4" id="workAdd">
                                                    <div class="form-group">
                                                        <label for="name">Work Address <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter Work Address" name="workaddress" value="{{$user->workaddress}}" id="workaddressinput">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="homeAdd">
                                                    <div class="form-group">
                                                        <label for="name">Home Address <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter Home Address" name="homeaddress" value="{{$user->homeaddress}}" id="homeaddressinput">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="addProof">
                                                    <div class="form-group">
                                                        <label for="name">Upload Address Proof Document <span
                                                            style="color: red">*</span></label>
                                                        <input type="file" name="addressproof" value="{{ $user->addressproof }}" class="form-control" id="addressproofinput">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="ageProof">
                                                    <div class="form-group">
                                                        <label for="name">Upload Age Proof Document <span
                                                            style="color: red">*</span></label>
                                                            <input type="file" name="document" class="form-control" id="documentinput" value="{{ $user->document }}">
                                                    </div>
                                                </div>
                                                {{-- <div class="col-md-4" id="wareCity">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4" id="wareSpocName">
                                                    <div class="form-group">
                                                        <label for="name">SPOC Name <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter SPOC Name" name="spoc_name" value="{{$user->spoc_name}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="wareSpocNumber">
                                                    <div class="form-group">
                                                        <label for="name">SPOC Number <span
                                                            style="color: red">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter SPOC Number" name="spoc_number" value="{{$user->spoc_number}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="vehicleChoose">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="multiSelect">
                                                            ...
                                                            @if($item->number == $user['vehicle'])
                                                                <option value="{{ $item->number }}" selected>{{ $item->name." ".$item->number }}</option>
                                                            @endif
                                                                <option value="{{ $item->number }}">{{ $item->name." ".$item->number }}</option>
                                                            @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name">City <span
                                                            ...
                                                            <select name="city" class="form-control"  id="cityinput">
                                                                ...
                                                                <option value="Dilhi" {{ $user->city == 'Dilhi' ? 'selected' : '' }}>Dilhi</option>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Enter Password"
                                                            name="password" value="{{ $user->showpassword }}">
                                                        @error('password')
                                                            <span style="color:red">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-12" id="note">
                                                    <div class="form-group">
                                                        <label for="name">Note</label>
                                                        <textarea  class="form-control" name="note" id="Note" placeholder="Enter Note" cols="30" rows="5" >{{$user->note}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mt-md-4 mt-3">
                                        <div class="col-12">
                                            ...
                                            <div class="btns d-inline-block">
                                                <a href="{{ url('hr/roles') }}"><button type="button"
