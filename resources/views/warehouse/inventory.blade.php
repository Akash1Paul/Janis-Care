                                                        ...
                                                        @foreach ($stocks as $key => $item)
                                                            <tr rowspan='2'>
                                                              ...
                                                              @endphp
                                                                ...
                                                                <td>
                                                                    <img src="{{ url('image/' . $item->image) }}"style="width:50px;height:50px;border-radius:50%"alt="">
                                                                </td>
                                                                @php
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a
                                                                        href="{{ url('warehouse/inventory-details/' . $item->product_id) }}"><button
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"> <a href="{{url('warehouse/inventory')}}">Inventory</a> > Details</h4>
                                </div>
                            </div>
                        </div>
            ...
            jQuery(document).ready(function() {
                ...
                $('#category').change(function() {
                    ...
                    if (category == 'all') {
                        ...
                        jQuery.ajax({
                            url: '{{ url('warehouse/filter-inventory') }}',
                            type: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
