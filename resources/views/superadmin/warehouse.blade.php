                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13">Inventory</h4>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    ...
                                                    <div class="mx-2">
                                                        <select class="form-control mx-2 filter" id="warehouse">
                                                    ...
                                                    {{-- <a href="{{ url('warehouse/add-stocks') }}"><button type="button"
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{url('superadmin/warehouse')}}">Inventory</a> > Details</h4>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    @isset($stocks)
                                                        @foreach ($stocks as $key => $item)
                                                            <tr rowspan='2'>
                                                                ...
                                                                <td>{{ $item->batch_id }}</td>
                                                                <td>{{ $item->product_name }}</td>
                                                                <td><button type="button" class="btn " data-toggle="modal" data-target=".bd-example-modal-sm{{$item->batch_id}}">
                                                <img src="{{ asset($item->barcode_path) }}" alt="Product Barcode" style="width: 200px;height:50px">   </button> </td>
                                                              ...
                                                              <td>{{ $item->categories }}</td>
                                                                ...
                                                                <td><img src="{{ url('image/' . $item->image) }}"
                                                                        ...
                                                                        <div class="modal fade bd-example-modal-sm{{ $item->batch_id }}"
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <img src="{{ asset($item->barcode_path) }}"
                                                                                                alt="Product Barcode"
                                                                                                style="width: 265px;height:50px">
                                                                                        </div>
                                                                                        <div class="modal-footer">
                                                                                            <button type="button" class="btn btn-warning"> <a
                                                                                                    href="{{ asset($item->barcode_path) }}"
            ...
            <script>
                jQuery(document).ready(function() {
                    $('#add-stocks{{ $item->id }}').click(function() {
                        ...
                        jQuery.ajax({
                            url: '{{ url('warehouse/upgrade-inventory') }}',
                            type: 'POST',
                            headers: {
        ...
        <script>
            jQuery(document).ready(function() {
                 ...
                 $('#warehouse').change(function() {
                    ...
                    var warehouse_email = $('#warehouse').val();
                if(warehouse_email == 'all')
                {
                    ...
                    var product_id = $('#product_ids').val();
                        ...
                        jQuery.ajax({
                            url: '{{ url('superadmin/filter-warehouse') }}',
                            type: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
    ...
    $('#category').change(function(){
        ...
        var category = $('#category').val();
                ...
                window.location.reload();
                    ...
                    jQuery.ajax({
                        url: '{{ url('superadmin/filter-product_id') }}',
                        type: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
