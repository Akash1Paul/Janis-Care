                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="fields d-flex">
                                                ...
                                                <div class="mr-1">
                                                    <a href="{{ url('superadmin/carts') }}"><button type="button" class="btn btn-primary waves-effect waves-light"> Add Order</button></a>
                                                </div>                                       
                                            </div>
                                            ...
                                            <table class="table table-bordered mb-0" id="datatable">
                                                ...
                                                <tbody id="filterorders">
                                                    ...
                                                    <tr >
                                                        ...
                                                        {{-- <td>{{ isset($users[$index]->email)?$users[$index]->name:'Not Found'  }}</td>    --}}
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('superadmin/add-orders/') }}" method="POST">
                                           @csrf
                                            <div class="row mt-4">
                                            ...
                                            <div class="row mt-md-4 mt-3">
                                                <div class="col-12">
                                                    ...
                                                    <div class="btns d-inline-block">
                                                        <a href="{{ url('superadmin/orders') }}"><button
                                                                type="button"
                                                                class="btn btn-dark waves-effect waves-light">Cancel</button></a>
                                                    </div>
                                                </div>
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-13"><a href="{{url('superadmin/orders')}}">Orders</a> > Order Details</h4>
                            </div>
                        </div>
                    </div>     
                    <!-- end page title -->
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('#status').change(function() {
                ...
                jQuery.ajax({
                    url: '{{ url('superadmin/filter-orders') }}',
                    type: 'POST',
                    headers: {
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('#phone').keyup(function() {
                ...
                jQuery.ajax({
                    url: '{{ url('superadmin/fetch-user-details') }}',
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
