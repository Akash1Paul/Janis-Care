                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="fields d-flex">
                                                ...
                                                <a href="{{ url('superadmin/add-users') }}"><button type="button"
                                                        class="btn btn-primary waves-effect waves-light">Add</button></a>

                                            </div>
                                        </div>
                                        <form action="{{ url('superadmin/rolesimport') }}" method="POST"
                                            ...
                                            <a class="btn btn-warning ml-3" href="{{ url('superadmin/rolesexport') }}">
                                                Export
                                            </a>
                                        </form>
                                                ...
                                                <tbody id="myTable">
                                                    @foreach ($users as $index => $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a
                                                                    href="{{ url('superadmin/edit-users/' . $item->email) }}">
                                                                    <button type="button"
                                                                        class="btn btn-primary waves-effect waves-light">Edit</button>
                                                                </a>
                                                                <a
                                                                    href="{{ url('superadmin/delete-users/' . $item->email) }}">
                                                                    <button type="button"
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{ url('superadmin/users') }}">Roles</a> >
                                        Add Role</h4>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('superadmin/add-users') }}" method="POST"
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-13"><a href="{{ url('superadmin/users') }}">Roles</a> > Edit
                                Roles</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ url('superadmin/edit-users/' . $user->email) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mt-4">
                                        <div class="col-md-4">
...
{{-- 
                                    ...
                                    <div class="row mt-md-4 mt-3">
                                        <div class="col-12">
                                            ...
                                            <div class="btns d-inline-block">
                                                <a href="{{ url('superadmin/users') }}"><button type="button"
                                                        class="btn btn-dark waves-effect waves-light">Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
