                  ...
                  <div class="row">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    <input type="text" id="search"  class="form-control" placeholder="Search ..." aria-label="Recipient's username"> required
                                                    ...
                                                    <a href="{{ url('superadmin/add-category') }}"><button type="button" class="btn btn-primary waves-effect waves-light ml-3">Add</button></a>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    @isset($category)
                                                        @foreach ($category as $key => $item)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a
                                                                        href="{{ url('superadmin/edit-category/' . $item->id) }}"><button
                                                                            class="btn btn-primary">Edit</button></a>
                                                                    <a
                                                                        href="{{ url('superadmin/delete-category/' . $item->id) }}"><button
                    ...
                    @elseif ($layout == 1)
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{url('superadmin/category')}}">Categories</a> > Add Categories</h4>
                                </div>
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('superadmin/add-category') }}" method="POST"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="validationTooltip01" required
                                                        name="sub_category" placeholder="Enter Sub Category">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationTooltip01"><b>Sub Sub Category <span style="color: red">*</span></b></label>
                                                    <input type="text" class="form-control" id="validationTooltip01" required
                                                        name="sub_sub_category" placeholder="Enter Sub Category">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                            ...
                                            <button class="btn btn-primary waves-effect waves-light" type="submit"> Add
                                                ...
                                                <div class="btns d-inline-block">
                                                    <a href="{{ url('superadmin/category') }}"><button type="button"
                    ...
                    @elseif($layout == 2)
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{url('superadmin/category')}}">Categories</a> > Edit Categories</h4>
                                </div>
                            </div>
                        </div> 
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('superadmin/edit-category/' . $category['id']) }}"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationTooltip01"><b>Sub Sub Category <span style="color: red">*</span></b></label>
                                                    <input type="text" class="form-control" id="validationTooltip01" required
                                                        name="sub_sub_category" placeholder="Enter Sub Category"  value="{{ $category['sub_sub_category'] }}">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationTooltip01"><b>Access (optional)</b></label>
                                                    <select name="access" id="" class="form-control" required>
