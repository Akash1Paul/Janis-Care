                ...
                <div class="container-fluid">
                                ...
                                <div class="card">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    ...
                                                    <a href="{{ url('backoffice/add-customers') }}"><button type="button" class="btn btn-primary waves-effect waves-light ml-3">Add</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    <form action="{{ url('backoffice/importcustomers') }}"
                                        method="POST"
                                    ...
                                    <div class="d-flex justify-content-end">
                                      ...
                                      <a class="btn btn-warning ml-3"
                                         href="{{ url('backoffice/exportcustomers') }}">
                                                Export
                                        </a>
                                    </div>
                                </div>
                                    </form>
                                    <form action="{{ url('backoffice/outletsimport') }}"
                                        method="POST"
                                        enctype="multipart/form-data" class="d-flex mt-4 justify-content-end">
                                      ...
                                      <a class="btn btn-warning ml-3"
                                         href="{{ url('backoffice/outletsexport') }}">
                                                Export
                                        </a>
                                    </div>
                                </div>
                                    </form>
                                    <form action="{{ url('backoffice/discountimport') }}"
                                        method="POST"
                                        enctype="multipart/form-data" class="d-flex mt-4 justify-content-end">
                                      ...
                                      <a class="btn btn-warning ml-3"
                                         href="{{ url('backoffice/discountexport') }}">
                                                Export
                                        </a>
                                    </div>
                                </div>
                                                    ...
                                                    @isset($customers)
                                                        @foreach ($customers as $key => $item)
                                                            <tr>
                                                                ...
                                                                <td>{{ $item->buisness_name }}</td>
                                                                <td>{{ $item->name }}</td>
                                                                <td>{{ $item->spoc_number }}</td>
                                                                <td>{{ $item->email }}</td>
                                                               
                                                                {{-- <td>{{ $item->showpassword }}</td> --}}
                                                               
                                                                <td>
                                                                    <a href="{{url('backoffice/customerdetails/'.$item->email)}}">
                    ...
                    @elseif ($layout == 1)
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{url('backoffice/customers')}}">Customers</a> > Add Customer</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('backoffice/add-customers') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mt-4" id="req_input">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="spoc_name" id="spocUser"
                                                        class="form-control" placeholder="Enter SPOC Name" required>
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="name">SPOC Contact <span
                                                            style="color: red">*</span></label>
                                                    <input type="number" name="spoc_number" id="spocContact"
                                                        class="form-control" placeholder="Enter SPOC Contact" required
                                                        maxlength="12" minlength="10">
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="name">Credit Amount <span
                                                            style="color: red">*</span></label>
                                                    <input type="number" name="credit_amount" id="creditAmount"
                                                        class="form-control" placeholder="Enter Credit Amount"
                                                        required>
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="name">Credit Period <span
                                                            style="color: red">*</span></label>
                                                    <input type="number" name="credit_period" id="creditPeriod"
                                                        class="form-control" placeholder="Enter Credit Period"
                                                        required>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="my-3 text-right">
                                                <a href="javascript:void(0)" id="addmore" class="add_input">Add Outlet</a>
                                            </div>
                                                    ...
                                                    $("#addmore").click(function() {
                                                        ...
                                                        $('body').on('keyup', '.fda-input', function() {
                                                          ...
                                                          // var outletNumber = $(this).attr('data-outlet'); // Get the outlet number from the attribute
                                                            ...
                                                            jQuery.ajax({
                                                                url: '{{ url('backoffice/check-fda-number') }}',
                                                                type: 'POST',
                                                                headers: {
                                                        ...
                                                        $('body').on('keyup', '.gst-input', function() {
                                                            ...
                                                            jQuery.ajax({
                                                                url: '{{ url('backoffice/check-gst-number') }}',
                                                                type: 'POST',
                                                                headers: {
                                                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                                                },
                                            ...
                                            <div class="row mt-md-4 mt-3">
                                                <div class="col-12">
                                                    ...
                                                    <div class="btns d-inline-block">
                                                        <a href="{{ url('backoffice/customers') }}"><button type="button"
                    ...
                    @elseif($layout == 2)
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <a href="{{ url('backoffice/customers') }}"><button
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('backoffice/edit-customers/' . $customer['email']) }}"
                                            ...
                                            {{-- <input type="hidden" name="password"
                                                ...
                                                <div class="row mt-4" id="req_input">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <input type="text" name="buisness_name" value="{{ $customer['buisness_name'] }}" id="Bname" class="form-control"
                                                            placeholder="Enter business name">
                                                    </div>
                                                    <div class="col-md-4 form-group">
                                                        <label for="name">Company name</label>
                                                        <input type="text" name="company_name" id="cName" value="{{ $customer['company_name'] }}" class="form-control"
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <input type="text" name="spoc_name" value="{{ $customer['spoc_name'] }}" id="spocUser" class="form-control" placeholder="Enter SPOC Name">
                                                    </div>
                                                    <div class="col-md-4 form-group">
                                                        <label for="name">SPOC Contact</label>
                                                        <input type="number" name="spoc_number" value="{{ $customer['spoc_number'] }}" id="spocContact" class="form-control" placeholder="Enter SPOC Contact">
                                                    </div>
                                                    <div class="col-md-4 form-group">
                                                        <label for="name">Credit Amount</label>
                                                        <input type="number" name="credit_amount" id="creditAmount" class="form-control" value="{{ $customer['credit_amount'] }}" placeholder="Enter Credit Amount">
                                                    </div>
                                                    <div class="col-md-4 form-group">
                                                        <label for="name">Credit Period</label>
                                                        <input type="number" name="credit_period" id="creditPeriod" class="form-control" value="{{ $customer['credit_period'] }}" placeholder="Enter Credit Period">
                                                    </div>
                                                    @php
                                                    ...
                                                    $billing_address = explode(',', $customer['billing_address']); $delivery_address = explode(',', $customer['delivery_address']); $outlet_email = explode(',', $customer['outlet_email']); 
                                                ...
                                                <div class="row px-3 required_inp">
                                                    ...
                                                    <div class="col-12 form-group">
                                                        ...
                                                        <div class="col-md-4 form-group">
                                                            ...
                                                            <input type="text" value="{{ $outlet_name[$i] }}" name="outlet_name[]" class="form-control" placeholder="Enter Outlet Name">
                                                        </div>
                                                        <div class="col-md-4 form-group">
                                                            <label for="name">Outlet SPOC</label>
                                                            <input type="text" value="{{ $outlet_spoc[$i] }}" name="outlet_spoc[]" class="form-control" placeholder="Enter SPOC">
                                                        </div>
                                                        <div class="col-md-4 form-group">
                                                            <label for="name">Outlet SPOC Number</label>
                                                            <input type="text" value="{{ $outlet_spoc_number[$i] }}" name="outlet_spoc_number[]" class="form-control" placeholder="Enter Number">
                                                        </div>
                                                        <div class="col-md-4 form-group">
                                                            <label for="simpleinput">Phone Number</label>
                                                            <input type="number" value="{{ $phone[$i] }}" name="phone[]" class="form-control" placeholder="Enter Number">
                                                        </div>
                                                        <div class="col-md-4 form-group">
                                                            <label for="simpleinput">GST Number</label>
                                                            <input type="text"  value="{{ $gst[$i] }}" name="gst[]" class="form-control" placeholder="Enter GST Number">
                                                        </div>
                                                        <div class="col-md-4 form-group">
                                                            <label for="simpleinput">FDA License Number</label>
                                                            <input type="text" value="{{ $fda_license_number[$i] }}" name="fda_license_number[]" class="form-control" placeholder="Enter FDA Number">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="name">Pincode</label>
                                                                <input type="text" value="{{ $pincode[$i] }}" name="pincode[]" class="form-control" placeholder="Enter Pincode">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="name">State</label>
                                                                <input type="text" value="{{ $state[$i] }}" class="form-control" name="state[]" placeholder="Enter State">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select name=city[] class="form-control">
                                                                    ...
                                                                    <option value="Dilhi" {{ $city[$i] == 'Delhi' ? 'selected' : '' }}>Delhi</option>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="document[]" type="file" class="form-control"  accept="image/*, .pdf">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="name">Billing Address</label>
                                                                <input type="text" value="{{ $billing_address[$i] }}" name="billing_address[]" class="form-control" placeholder="Enter Billing Address">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="name">Delivery Address</label>
                                                                <input type="text" class="form-control" value="{{ $delivery_address[$i] }}" name="delivery_address[]" placeholder="Enter Delivery Address">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 form-group">
                                                            <label for="email">Email address</label>
                                                            <input type="email" value="{{$outlet_email[$i]}}" name="outlet_email[]" class="form-control" id="email" placeholder="name@example.com">
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="name">Note</label>
                                                                <textarea class="form-control"  name="note[]" id="Note" placeholder="Enter Note" cols="30" rows="5">{{ $note[$i] }}</textarea>
                                                            </div>
                                                        </div>
                                                    @endfor
                                                </div>
                    ...
                    @elseif($layout == 3)
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
                                            <li class="breadcrumb-item active">Discount Customer</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form
                                            action="{{ url('backoffice/discount-customers/' . $customer['email']) }}"
                                            method="POST" enctype="multipart/form-data">
                                            @csrf
                                                                ...
                                                                <td>
                                                                    <input type="text" value="{{ $item->price }}"
                                                                        readonly class="form-control">
                                                                           ...
                                                                           @php
                                                                $discount_price = isset($customer['discount_price'][$key]) && $customer['discount_price'][$key] != null ? $customer['discount_price'][$key] : $item->price;
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{url('backoffice/customers')}}">Customers</a> > All Details</h4>
                                </div>
                            </div>
                        </div>     
                        <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="details">
                                                                <table>
                                                                    <tr>
                                                                        <td><p>Photo:</p></td>
                                                                        <td><a href="{{url('image/'.$customers->photo)}}" target="_blank">
                                                                            <img src="{{url('image/'.$customers->photo)}}" height="50px" width="50px"></a>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><p>Date:</p></td>
