                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{url('backoffice/correction')}}">Correction</a> > Customer All Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <form action="{{url('backoffice/changestatus/'.$customers->email)}}" method="post">
                                    @csrf
                                    @if($customers->status != 'Approved')
                                  <div class="col-md-6">
                                    <div class="fields">   
                                  ...
                                  <div class="row px-3 mt-4">
                                     <div class="col-12">
                                        ...
                                        <div class="btns d-inline-block">
                                            <a href="{{url('backoffice/correction')}}"><button type="button" class="btn btn-dark waves-effect waves-light">Cancel</button></a>
                                        </div>
                                     </div>
                                  </div>
                                  @endif
