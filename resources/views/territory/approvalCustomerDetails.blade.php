                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-13"><a href="{{url('territory/correction')}}">Correction</a> > Customer Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <!-- end card-body-->
                                    <form action="{{url('territory/changestatus/'.$customers->email)}}" method="post">
                                        @csrf
                                      ...
                                      <div class="row px-3 mt-4">
                                         <div class="col-12">
                                            ...
                                            <div class="btns d-inline-block">
                                                <a href="{{url('territory/correction')}}"><button type="button" class="btn btn-dark waves-effect waves-light">Cancel</button></a>
                                            </div>
                                         </div>
                                      </div>
                                      @endif
